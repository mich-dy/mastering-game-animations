...
struct InstanceSettings {
  ...
  // storage for physics reset
  glm::vec3 isOrigWorldPosition = glm::vec3(0.0f);
  glm::vec3 isOrigWorldRotation = glm::vec3(0.0f);
  float isOrigScale = 1.0f;
