...
struct ModelSettings {
  ...
  bool msPhysicsEnabled = false;
  physicsHullType msPhysicsHullType = physicsHullType::cube;
  glm::vec3 msPhysicsHullSize = glm::vec3(1.0f);
  glm::vec3 msPhysicsHullOffset = glm::vec3(0.0f);
  glm::vec3 msPhysicsHullRotation = glm::vec3(0.0f);
