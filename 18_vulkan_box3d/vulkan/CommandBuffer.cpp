...
bool CommandBuffer::init(VkRenderData &renderData, VkCommandPool pool, VkCommandBuffer& commandBuffer) {
...
VkCommandBuffer CommandBuffer::createSingleShotBuffer(VkRenderData &renderData, VkCommandPool pool) {
  Logger::log(2, "%s: creating a single shot command buffer\n", __FUNCTION__);
  VkCommandBuffer commandBuffer;

  if (!init(renderData, pool, commandBuffer)) {
