...
struct ModelInstanceCamData {
  ...
  std::unordered_map<physicsHullType, std::string> micPhysicsHullTypeMap{};
  std::unordered_map<physicsBodyType, std::string> micPhysicsBodyTypeMap{};
  ...
  resetPhysicsCallback micResetPhysicsCallbackFunction;
  singleStepPhysicsCallback micSingleStepPhysicsCallbackFunction;
  bakePhyiscsDataCallback micBakePhyiscsDataCallbackFunction;
};
