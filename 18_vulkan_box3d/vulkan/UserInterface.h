...
class UserInterface {
  ...
  private:
    ...
    std::vector<float> mPhysicsValues{};
    int mNumPhysicsValues = 90;
    ...
    std::shared_ptr<AssimpDynLight> mCurrentDynLight = nullptr;
};
