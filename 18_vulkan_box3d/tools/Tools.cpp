...
glm::quat Tools::box3dToGlm(b3Quat value) {
  return glm::normalize(glm::quat(value.s, value.v.x, value.v.y, value.v.z));
  //return glm::quat(value.v.x, value.v.y, value.v.z, value.s);
}

glm::vec3 Tools::box3dToGlm(b3Vec3 value) {
  return glm::vec3(value.x, value.y, value.z);
}

b3Vec3 Tools::glmToBox3d(glm::vec3 value) {
  return b3Vec3{ value.x, value.y, value.z };
}

b3Quat Tools::glmToBox3d(glm::quat value) {
  return b3NormalizeQuat(b3Quat{ { value.x, value.y, value.z }, value.w });
}
