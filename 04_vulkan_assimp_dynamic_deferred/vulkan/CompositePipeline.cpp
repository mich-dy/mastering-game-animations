...
bool CompositePipeline::init(VkRenderData& renderData, std::vector<VkFormat> colorAttachmentFormats,
  ...
  colorBlendingInfo.attachmentCount = static_cast<uint32_t>(colorAttachmentFormats.size());
...
void CompositePipeline::cleanup(VkRenderData &renderData, VkPipeline &pipeline) {
