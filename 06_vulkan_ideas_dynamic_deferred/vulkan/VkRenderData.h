...
struct VulkanGBuffer {
  VkFrameBufferData color;
  VkFrameBufferData normal;
  VkFrameBufferData position;
  uint32_t width;
  uint32_t height;
};
...
struct VkRenderData {
  ...
  VkSampler rdSelectionImageSampler = VK_NULL_HANDLE;
  VkDescriptorSet rdSelectionImageUIDescriptorset = VK_NULL_HANDLE;
